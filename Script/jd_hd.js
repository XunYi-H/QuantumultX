...
let toolSelectors = $.getData('id77_tools_selectors');
let urlSku;
...
try {
  ...
  tools =
    ...
    // (toolSwitch === 'Y' && toolSelectors
    //   ? `<div id="startTool" class="_${prefix}_id77_btn_b"></div>`
    //   : '') +
    `<div id="reload" class="_${prefix}_id77_btn _${prefix}_id77_hide" onclick="location.reload()"></div>` +
    `<div id="id77_clear" class="_${prefix}_id77_btn _${prefix}_id77_hide" onclick="_${prefix}_id77_clearData()"></div></div>`;
  ...
  mitmContent += `
    ...
    * {
    ...
    #startTool {
      top: 40.7571em;
      background: url(data:image/svg+xml;base64,) #FFF no-repeat 0.3571em/1.88em;
    }
    .vc-panel {
  ...
  <script ignore>
    ...
    function _${prefix}_id77_init () {
      ...
      try {
        ...
        const startToolDom = document.querySelector('#startTool');
        if (startToolDom) {
          startToolDom.addEventListener('click', async (e) => {
            try {
              let selectors = '${toolSelectors}'.split(',');
              for (let i = 0; i < selectors.length; i++) {
                const dom = document.querySelector(selectors[i]);
                if (dom) {
                  dom.click();
                }
              }
